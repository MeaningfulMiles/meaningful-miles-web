...
const charities = [
  ...
  {
    name: "Project WHY",
    type: "Education & Empowerment · South Delhi & Dehradun",
    about:
      "Project WHY's vision is a world where all children have quality education, the support to build their skills, and a voice. Running 5 after-school support centres across South Delhi and one in Dehradun, Project WHY reaches over 1,200 children every year. Since its founding, the organisation has transformed the lives of over 10,000 children and women — from the Yamuna floodplain to Govind Puri — one classroom, one child, one changed life at a time.",
    whatYouDo:
      "Volunteers support after-school tuition across all age groups, assist with computer and digital literacy sessions, help develop teaching materials, support skill development programmes for women and youth, contribute to fundraising and communications, and bring whatever professional expertise they carry — whether in education, technology, social work or mental health — to a community that will embrace every bit of it.",
    suits: [
      "Teachers and educators at any level",
      "Social workers and community development professionals",
      "Mental health professionals and students",
      "Digital and tech volunteers",
      "Anyone who believes education is the most powerful force in the world",
    ],
    commitment: "1 month (as requested by Project WHY)",
...
const WhereYoullGivePage = () => (
  <PageLayout>
    <Helmet>
      ...
      <meta
        name="description"
        content="Meet our three award-winning partner charities in Delhi — animal welfare, disability inclusion, and children's education. Discover where your skills and time will matter most."
      />
    </Helmet>
    ...
    <section className="section-padding bg-forest-green text-center">
      <ScrollReveal>
        ...
        <p className="font-display text-xl md:text-2xl text-primary-foreground/90 max-w-3xl mx-auto">
          Three award-winning Indian charities. One transformative journey.
        </p>
      </ScrollReveal>
    </section>
